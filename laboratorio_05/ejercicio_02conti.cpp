//CONTINUACION DEL EJERCICIO 02, ESTE TIENE LAS OPCIONES DE SUMAR ELEMENTOS PARES E IMPARES CONTENIDOS EN NODOS... 
//CONSIDERAR QUE YA TENIA SUEÑO PLOX xd
...
int sumaNodosImpares(nodo *arbol);
int sumaNodosPares(nodo *arbol);
...
void menu(){
	...
	do{
		...
		cout<<"4. Efectuar suma de nodos pares."<<endl;
		cout<<"5. Efectuar suma de nodos impares."<<endl;
		cout<<"6. Cantidad de nodos negativos, ceros o positivos."<<endl;
		...
		switch(opcion){
			...
			case 3: 
			    ...
			    break;
			case 4:
				cout<<"La sumatoria de los elementos en los nodos pares es: "<< sumaNodosPares(arbol)<<endl;
				system("pause");
			    break;
			case 5:
				cout<<"La sumatoria de los elementos en los nodos impares es: "<< sumaNodosImpares(arbol)<<endl;
				system("pause");
			    break;
			case 6: 
...
int sumaNodosImpares(nodo *arbol){
    if(arbol != NULL){
    	...
    	int izq=sumaNodosImpares(arbol->izq);
    	int der=sumaNodosImpares(arbol->der);
    	return izq + centro + der;
		}else{
			return sumaNodosImpares(arbol->izq) + sumaNodosImpares(arbol->der);
		}
	}else{
		return 0;
	}
...
int sumaNodosPares(nodo *arbol){
    if(arbol != NULL){
    	if(arbol->dato % 2 == 0){
    	int centro = arbol->dato;
    	int izq=sumaNodosPares(arbol->izq);
    	int der=sumaNodosPares(arbol->der);
    	return izq + centro + der;
		}else{
			return sumaNodosPares(arbol->izq) + sumaNodosPares(arbol->der);
		}
	}else{
		return 0;
	}
